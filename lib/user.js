User = function (socket) {
  ...
  this.user = {username: username, coordinate: {x: 0, y: 0, z: 1}, uniqueID: uniqueID};
...
User.prototype.verify = function(updated_player) {
   if(typeof map.get_player(updated_player.uniqueID) === 'undefined')
   {
     return false;
   }
   return true;
...
User.prototype.update_map = function(new_data) {
  var old_data = map.get_player(new_data.uniqueID);
