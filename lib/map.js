module.exports = {
  ...
  add_player: function(new_player) {
    this.players[new_player.uniqueID] = new_player;
  ...
  update_player: function(updated_player) {
    ...
    this.players[updated_player.uniqueID] = updated_player;
  },

  get_player: function(uniqueID) {
